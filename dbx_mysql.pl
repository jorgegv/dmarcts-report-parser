    ...
    tables => {
        ...
        "rptrecord" => {
            column_definitions => [
                ...
                "",
                "dkimresult",
                "enum('" . join( "','", ALLOWED_DKIMRESULT ) . "')",
                "",
                "spfdomain",
                "varchar(255)",
                "",
                "spfresult",
                "enum('" . join( "','", ALLOWED_SPFRESULT ) . "')",
                "",
                "spf_align",
                "enum('" . join( "','", ALLOWED_SPF_ALIGN ) . "')",
                "NOT NULL",
                "dkim_align",
                "enum('" . join( "','", ALLOWED_DKIM_ALIGN ) . "')",
                "NOT NULL",
                "identifier_hfrom",
                "varchar(255)",
                ""
        ...
        "metric" => {
            column_definitions => [
                "id",                                           "int",
                "unsigned NOT NULL AUTO_INCREMENT PRIMARY KEY", "date",
                "datetime",                                     "NOT NULL",
                "num_total",                                    "int",
                "unsigned NOT NULL",                            "num_rejected",
                "int",                                          "unsigned NOT NULL",
                "num_quarantined",                              "int",
                "unsigned NOT NULL",                            "num_align_failed",
                "int",                                          "unsigned NOT NULL",
                "num_dkim_failed",                              "int",
                "unsigned NOT NULL",                            "num_spf_failed",
                "int",                                          "unsigned NOT NULL",
                "num_spf_dkim_failed",                          "int",
                "unsigned NOT NULL",                            "num_dkim_permerror",
                "int",                                          "unsigned NOT NULL",
                "num_spf_permerror",                            "int",
                "unsigned NOT NULL",
            ],
